...
class member(osv.osv):
    ...
    _columns ={
            ...
            "member_charge_ids" : fields.one2many('ktv.member_charge','member_id',help="会员充值记录"),
            "member_consumption_ids" : fields.one2many('ktv.member_consumption','member_id',help="会员消费记录"),
            "balance": fields.function(_compute_balance_and_points,type='float',multi="compute_fields",string="balance",digits_compute = dp.get_precision('ktv_fee'),help="卡余额"),
